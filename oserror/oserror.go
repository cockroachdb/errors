...
func IsExist(err error) bool {
	// errors.Is() is not able to peek through os.SyscallError,
	// whereas os.IsPermission() can. Conversely, os.IsExist()
	// cannot peek through Unwrap, whereas errors.Is() can. So we
	// need to try both.
...
func IsNotExist(err error) bool {
	// errors.Is() is not able to peek through os.SyscallError,
	// whereas os.IsPermission() can. Conversely, os.IsNotExist()
	// cannot peek through Unwrap, whereas errors.Is() can. So we
	// need to try both.
...
func IsTimeout(err error) bool {
	// errors.Is() is not able to peek through os.SyscallError,
	// whereas os.IsPermission() can. Conversely, os.IsTimeout()
	// cannot peek through Unwrap, whereas errors.Is() can. So we
	// need to try both.
