...
func UnaryServerInterceptor(
	...
	if !ok {
		...
		if err != nil {
			...
			//
			// More specifically, an error here is from anypb.New(detail), which probably
			// means that your proto.Message is not registered with the standard protobuf
			// registry.  (Make sure that your error's .pb.go file was generated by the
			// standard protoc-gen-go, which registers its types with
