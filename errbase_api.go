...
// or a different type, ensure that RegisterTypeMigration() was called
// prior to RegisterWrapperEncoder().
func RegisterWrapperEncoderWithMessageOverride(typeName TypeKey, encoder errbase.WrapperEncoderWithMessageType) {
...
type WrapperEncoderWithMessageOverride = errbase.WrapperEncoderWithMessageType
