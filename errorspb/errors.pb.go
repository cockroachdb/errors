...
type EncodedErrorLeaf struct {
	...
	// causes is a list of errors that contain the causal tree
	// of this leaf. If this field is not empty, then this leaf
	// encodes an error from go 1.20 or later that encodes multiple
	// causes in its chain.
	Causes []*EncodedError `protobuf:"bytes,3,rep,name=causes,proto3" json:"causes,omitempty"`
}
...
var fileDescriptor_ddc818d0729874b8 = []byte{
	...
	,
}
